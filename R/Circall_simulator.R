...
Circall_simulator <- function(BSJ_Info,tandem_rate = 0,error_rate = 0.005,set.seed = 2018,gtfSqlite,genomeFastaFile,txFastaFile,out_name = "Circall_simuation",out_dir = "./",...){
