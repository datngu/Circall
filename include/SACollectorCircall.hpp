...
#ifndef SA_COLLECTOR_Circall_HPP
#define SA_COLLECTOR_Circall_HPP
...
class SACollectorCircall {
    public:
    using OffsetT = typename RapMapIndexT::IndexType;
    using SAIntervalHit = rapmap::utils::SAIntervalHit<OffsetT>;
    
    SACollectorCircall(RapMapIndexT* rmi) : rmi_(rmi) {}
...
#endif // SA_COLLECTOR_Circall_HPP
